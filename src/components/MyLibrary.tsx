                ...
                >
                  ...
                  <div className="flex items-center justify-end gap-2 pt-2 sm:pt-0">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 active:scale-95 text-white text-xs font-semibold rounded-xl shadow-2xs transition-all flex items-center gap-1.5"
                    >
